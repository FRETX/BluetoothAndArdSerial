...
public class PlayingLearnTwoFragment extends Fragment {
    //    MediaController mc;
    Button   btLearned;
    Button   btPlayReplay;
    TextView tvTitle;
    ...
    public PlayingLearnTwoFragment(){
...
//                stopViaData();
    ...
    public void initTxt()
    {
        String str= readRawTextFile(mActivity.getBaseContext(), R.raw.extwo);
