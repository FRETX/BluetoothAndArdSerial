...
public class PlayingLearnThreeFragment extends Fragment {
    //    MediaController mc;
    Button   btLearned;
    Button   btPlayReplay;
    TextView tvTitle;
    ...
    public PlayingLearnThreeFragment(){
    ...
    private void initUI() {
        ...
        tvTitle.setText("Exercise3 - Em Asus2 Chord");
        ...
        videoUri = Uri.parse("android.resource://" + mActivity.getPackageName() + "/" + R.raw.learn_ex3);
...
//                stopViaData();
    ...
    public void initTxt()
    {
        String str= readRawTextFile(mActivity.getBaseContext(), R.raw.exthree);
