...
public class PlayingSongOneFragment extends Fragment {
    ...
    private void initUI() {
        ...
        tvEndTime.setText("0");
        videoUri = Uri.parse("android.resource://" + mActivity.getPackageName() + "/" + R.raw.songloopoff1);
...
//                stopViaData();
    ...
    public void initTxt()
    {
        String str= readRawTextFile(mActivity.getBaseContext(), R.raw.songloopoff1txt);
